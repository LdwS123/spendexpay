...
export default function PainKillerBanner() {
  return (
    <section
      ...
      className="mb-5 overflow-hidden rounded-2xl border border-[#6D5BFF]/25 bg-gradient-to-br from-[#0D0F14] via-[#0a1322] to-[#0e1a2d] text-white"
    >
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 px-5 py-5 sm:px-6 sm:py-6">
        <div className="flex-1 min-w-0">
          <p className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-[#6D5BFF]">
            <span
              className="inline-flex h-1.5 w-1.5 rounded-full bg-[#6D5BFF]"
              aria-hidden="true"
            />
            Ready to ship
          </p>
        ...
        <Link
          href="/docs"
          className="shrink-0 inline-flex items-center gap-2 rounded-lg bg-[#6D5BFF] px-4 py-2.5 text-sm font-semibold text-[#0D0F14] transition-colors hover:bg-[#5b48ff] self-start sm:self-auto"
        >
          Setup in 2 minutes →
        </Link>
      </div>
